...
<template>
  <header class="flex items-center justify-between px-4 gap-8 border-b-2 border-black h-20 bg-[#ffffff]">
    ...
    <div class="flex items-center gap-4">
      <img src="/public/img/connexion.png" class="relative z-10 flex h-12 w-12 flex-col justify-between lg:hidden *:block *:ease *:h-[2px] *:w-full">
      <button
        @click="activeMenu = !activeMenu"
      >
        <img src="/public/img/menu.svg" class="relative z-10 flex h-12 w-12 flex-col justify-between lg:hidden *:block *:ease *:h-[2px] *:w-full">
